...
class TestSolutions(unittest.TestCase):
    ...
    def test_s4c31(self):
        ...
        eq(
            hmac.hmac_md5(b"key", b"The quick brown fox jumps over the lazy dog"),
            "80070713463e7749b90c2dc24911e275",
        )

        eq(
            hmac.hmac_sha1(b"key", b"The quick brown fox jumps over the lazy dog"),
            "de7c9b85b8b78aa6bc8a7a36f70a90701c9db4d9",
        )

        eq(
            hmac.hmac_sha256(b"key", b"The quick brown fox jumps over the lazy dog"),
